...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  const yScroll = useTransform(scrollYProgress, [0, 1], [-50, 70]);

  return (
    <div className={`max-w-full ${type === "right" ? "sm:mt-36 mt-0" : ""}`}>
      <div className="overflow-clip aspect-[calc(16/12)] relative w-full h-auto flex items-center justify-center">
        <motion.div
